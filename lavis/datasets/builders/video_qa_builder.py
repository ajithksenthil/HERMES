...
from lavis.datasets.datasets.moviecore_vqa_datasets import (
    MovieCoreVQADataset,
    MovieCoreVQAEvalDataset,
)
...
@registry.register_builder("moviecore_qa")
class MovieCoreQABuilder(VideoQABuilder):
    train_dataset_cls = MovieCoreVQADataset
    eval_dataset_cls = MovieCoreVQAEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/moviecore/defaults_qa.yaml",
    }
